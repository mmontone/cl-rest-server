...
(defmacro define-oauth-resource (api-name)
  ...
  `(progn
     ...
     (implement-api-function ,api-name register-oauth-consumer ()
       (let ((token
     ...
     (implement-api-function ,api-name get-oauth-user-authorization ()
     ...
     (implement-api-function ,api-name get-oauth-access-token ()
